...
itemPatterns = {
	...
	{ p = "%+(%d+) к искусности", s = "MASTERY" },
	{ p = "%+(%d+) к показателю искусности", s = "MASTERY" },
	{ p = "%+(%d+) к скорости", s = "HASTE" },
	{ p = "%+(%d+) к PvP%-силе", s = "PVP_POWER" },
	{ p = "%+(%d+) к PvP%-устойчивости", s = "PVP_PROTECT" },
	{ p = "%+(%d+) к показателю скорости", s = "HASTE" },
	{ p = "%+(%d+) к меткости", s = "HIT" },
	{ p = "%+(%d+) к показателю меткости", s = "HIT" },
	{ p = "%+(%d+) к мастерству", s = "MAST" },
	{ p = "%+(%d+) к показателю мастерства", s = "MAST" },
	{ p = "%+(%d+) к уклонению", s = "AVOIDANCE" },
	{ p = "%+(%d+) к парированию", s = "PARRY" },
	{ p = "%+(%d+) к показателю критического удара", s = "CRIT" },
